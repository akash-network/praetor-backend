...
class ProviderPostRequest(BaseModel):
    session_id: str
    domain_name: str
    attributes: list
    ...
    bid_price_hd_pres_ssd_scale: Optional[str] = "0.03"  # USD/GB-month (beta1)
    bid_price_hd_pres_nvme_scale: Optional[str] = "0.04"  # USD/GB-month (beta1)
    ...
    bid_deposit: str
    persistent_type: Optional[str] = None
    persistent_price: Optional[str] = None
